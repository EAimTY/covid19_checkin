...
**使用本脚本代表你已了解并愿意承担使用本脚本打卡的风险**

**由于学校更换了认证系统，本脚本暂时失效，请关注后续更新**

# 功能

用于替代手动在某校健康信息系统打卡的 PHP 脚本

在脚本中设置学号与密码后，运行脚本进行健康信息系统打卡（在使用本脚本之前需手动成功打卡至少一次，脚本会使用最近一次成功打卡的数据进行打卡）

脚本会自动填写“健康码为绿色”，请勿在健康码非绿色时使用本脚本！
